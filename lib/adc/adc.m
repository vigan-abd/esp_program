 ...
 *(.text)
 ...
 .text          0x000000a4       0x58 adc.o
                0x000000a4                adc_init
                0x000000b8                adc_get_raw
 .text          0x000000fc        0x0 /usr/lib/gcc/avr/4.5.3/avr51/libgcc.a(_exit.o)
                0x000000fc                . = ALIGN (0x2)
 *(.text.*)
 .text.libgcc   0x000000fc        0x0 /usr/lib/gcc/avr/4.5.3/avr51/libgcc.a(_exit.o)
                0x000000fc                . = ALIGN (0x2)
 *(.fini9)
 .fini9         0x000000fc        0x0 /usr/lib/gcc/avr/4.5.3/avr51/libgcc.a(_exit.o)
                0x000000fc                exit
                0x000000fc                _exit
 *(.fini9)
 *(.fini8)
 ...
 *(.fini1)
 *(.fini0)
 .fini0         0x000000fc        0x4 /usr/lib/gcc/avr/4.5.3/avr51/libgcc.a(_exit.o)
 *(.fini0)
                0x00000100                _etext = .

.data           0x00800100        0x0 load address 0x00000100
 ...
 *(COMMON)
                ...
                0x00000100                __data_load_start = LOADADDR (.data)
                0x00000100                __data_load_end = (__data_load_start + SIZEOF (.data))
 ...
 *(.debug_pubnames)
 .debug_pubnames
                0x00000000       0x2f adc.o

.debug_info     0x00000000       0xd9
 *(.debug_info)
 .debug_info    0x00000000       0xd9 adc.o
 *(.gnu.linkonce.wi.*)

.debug_abbrev   0x00000000       0x97
 *(.debug_abbrev)
 .debug_abbrev  0x00000000       0x97 adc.o

.debug_line     0x00000000       0xf1
 *(.debug_line)
 .debug_line    0x00000000       0xf1 adc.o
 ...
 *(.debug_str)
 .debug_str     0x00000000       0x9e adc.o
                                 0xd2 (size before relaxing)

.debug_loc      0x00000000       0x98
 *(.debug_loc)
 .debug_loc     0x00000000       0x98 adc.o
